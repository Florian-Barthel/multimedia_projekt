    ...
    for i in progress_bar_train:
        ...
        if (i + 1) % 1000 == 0:
            ...
            for j in range(len(validation_data)):
                ...
                probabilities_output, anchor_grid_adjusted_output = sess.run([probabilities, anchor_grid_adjusted],
                ...
                evaluation.prepare_detections(probabilities_output, anchor_grid_adjusted_output, test_paths, detection_path_bbr)
            ...
            draw.draw_images(num_images=5,
                             ...
                             adjusted_anchor_grid=anchor_grid_adjusted_output,
